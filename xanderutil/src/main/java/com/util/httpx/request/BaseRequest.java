...
import com.util.core.xhttp.adapter.CacheCall;
import com.util.core.xhttp.adapter.Call;
import com.util.core.xhttp.adapter.CallAdapter;
import com.util.core.xhttp.adapter.DefaultCallAdapter;
...
import com.util.core.xhttp.convert.Converter;
...
public abstract class BaseRequest<R extends BaseRequest> {
    ...
    public okhttp3.Call generateCall(Request request) {
        ...
        if (readTimeOut <= 0 && writeTimeOut <= 0 && connectTimeout <= 0 && interceptors.size() == 0) {
            return JJHttp.getInstance().getOkHttpClient().newCall(request);
        } else {
            OkHttpClient.Builder newClientBuilder = JJHttp.getInstance().getOkHttpClient().newBuilder();
